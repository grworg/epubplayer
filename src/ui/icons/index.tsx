...
export function RewindIcon(props: IconProps) {
  return (
    ...
    >
      ...
      <path d="M3 3v5h5" />
      <text x="12" y="15" fontSize="6" textAnchor="middle" fill="currentColor" stroke="none">
        30
      </text>
    </svg>
  )
...
// Clear / remove cached content (distinct from permanent delete)
export function EraserIcon(props: IconProps) {
  return (
    ...
    >
      <path d="M20 20H7" />
      <path d="M3 16l9-9a2.5 2.5 0 0 1 3.54 0l3.46 3.46a2.5 2.5 0 0 1 0 3.54L13.5 20H7l-4-4z" />
      <path d="M7 20l6-6" />
    </svg>
  )
}
...
export function DeviceSyncIcon(props: IconProps) {
  return (
    ...
    >
      {/* Laptop */}
      <path d="M4 6h12a2 2 0 0 1 2 2v6" />
      <path d="M2 16h14" />
      <path d="M4 6v10" />
      {/* Phone */}
